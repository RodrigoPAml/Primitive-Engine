...
namespace PrimitiveEngine
{
	namespace Drawing
	{
		void Primitives3D::DrawCube(const glm::vec3& position, const glm::vec3& size, const glm::vec3& eulerAngles, const glm::vec3& color, const bool filled)
		{
			...
			instance.Setup(position, size, eulerAngles, color);
		...
		void Primitives3D::DrawPoint(const glm::vec3& position, const glm::vec3& color)
		{
			...
			instance.Setup(position, {1,1,1}, {0,0,0}, color);
		...
		void Primitives3D::DrawLine(const glm::vec3& pos1, const glm::vec3& pos2, const glm::vec3& color)
		{
			...
			instance.Setup({ 0,0,0 }, { 1,1,1 }, { 0,0,0 }, color);
		...
		void Primitives3D::DrawCircle(const glm::vec3& pos, const glm::vec3& size, const glm::vec3& eulerAngles, const glm::vec3& color, const bool filled)
		{
			...
			instance.Setup(pos, size, eulerAngles, color);
		...
		void Primitives3D::DrawMeshTest(GPU::VertexPtr mesh, glm::vec3 position, glm::vec3 color, GPU::DrawingType type)
		{
			auto instance = Instance();
		...
		void Primitives3D::Init()
		{
			...
			Debug::Logging::Log("Primitives3D", "Initialized");
		}
		...
		void Primitives3D::Release()
		{
			...
			Debug::Logging::Log("Primitives3D", "Released");
		}

		void Primitives3D::Setup(const glm::vec3& position, const glm::vec3& size, const glm::vec3& eulerAngles, const glm::vec3& color)
		{
			const Camera::Camera3DPtr cam = Camera::Camera3D::GetCurrentCamera();

			if (cam == nullptr)
				Debug::Logging::LogException("Primitives3D", "Attempt to draw a 3D primitive without a camera");
