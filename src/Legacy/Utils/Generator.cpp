	...
	namespace Utils
	{
		namespace Generator
		{
			GPU::VertexPtr Generate2DPoint(const GPU::DataUse use)
			{
				...
				VertexElement element(VertexDataType::FLOAT, 2);

				VertexDescriptor descriptor({{{element}, verticesPoint, use}}, 1);
			...
			GPU::VertexPtr Generate2DLine(const GPU::DataUse use)
			{
				...
				VertexDescriptor descriptor({{{element}, verticesLine, use}}, 2);
			...
			GPU::VertexPtr Generate3DPoint(const GPU::DataUse use)
			{
				...
				VertexElement element(VertexDataType::FLOAT, 3);

				VertexDescriptor descriptor(
					{{{element}, verticesPoint, use}}, 
					1
				);
