...
namespace PrimitiveEngine
{
	namespace Window
	{
		...
		public:
			...
			/// </summary>
			static void Init(
				const WindowConfiguration& windowConfig = WindowConfiguration(),
				const Debug::DebugConfiguration& debugConfiguration = Debug::DebugConfiguration(),
				const Debug::LoggingConfiguration& loggingConfiguration = Debug::LoggingConfiguration()
			);
